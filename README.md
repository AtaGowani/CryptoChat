...
## Executing locally
Each component must be running on a sperate instance in order for the application to function as intended. Instructions to run each component can be found in its respective directory.